        ...
        child: RefreshIndicator(
          ...
          child: contributionsAsync.when(
            ...
            data: (contributions) {
              ...
              // QA_PRODUCTION_AUDIT_2026-09-11.md L1 — the fixed sections
              // above the contribution list stay as single items (they're
              // not what grows unboundedly); the contribution rows below
              // them are grouped into one GroupCard item, preserving its
              // shared-card visual style rather than splitting each row into
              // its own top-level list item.
